...
<div class="listDataTableDiv" style="font-size: 14px !important; line-height: 20px !important;">
    <table class="table table-striped table-bordered table-hover  table-condensed"
        ...
        <tr class="success" style="font-size: 14px !important; line-height: 20px !important;">
            ...
            <th style="font-size: 14px !important; line-height: 20px !important;">年级</th>
        ...
        <c:forEach items="${students}" var="student" varStatus="st">
            <tr style="font-size: 14px !important; line-height: 20px !important;">
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.id}</td>
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.name}</td>
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.sex}</td>
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.grade}</td>
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.telphone}</td>
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.email}</td>
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.account}</td>
                <td style="font-size: 14px !important; line-height: 20px !important;">${student.password}</td>
                <td style="font-size: 14px !important;">
                    <a href="/adminStudentEdit?id=${student.id}" style="font-size: 14px !important;" >
                        <span class="glyphicon glyphicon-edit" style="font-size: 14px !important;"></span>
                    </a>
                </td>
                <td style="font-size: 14px !important;">
                    <a href="/adminStudentDelete?id=${student.id}" style="font-size: 14px !important;" >
...
<div align="center" class="pageDiv" style="font-size: 14px !important; line-height: 20px !important;">
    ...
    <br>
    <div align="center">
        <form action="/adminStudentAdd" method="post" enctype="multipart/form-data">
            <table class="addTable" style="font-size: 14px !important; line-height: 20px !important;">
                ...
                <tr style="font-size: 14px !important; line-height: 20px !important;">
                    ...
                    <td style="font-size: 14px !important;"><input id="open" name="grade"  class="form-control" style="font-size: 14px !important;" type="text"></td>
                </tr>
