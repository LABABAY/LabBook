        ...
        <c:forEach items="${books}" var="book" varStatus="st">
            <tr style="font-size: 14px !important; line-height: 20px !important;">
                ...
                <td style="font-size: 14px !important;">
                    <a href="/teacherVerifyPass?id=${book.id}" style="font-size: 14px !important;" >
                        <span class="glyphicon glyphicon-ok" style="font-size: 14px !important;"></span>
                    </a>
                </td>
                <td style="font-size: 14px !important;"><a href="/teacherVerifyRefuse?id=${book.id}" style="font-size: 14px !important;"><span class="glyphicon glyphicon-remove" style="font-size: 14px !important;"></span></a></td>
