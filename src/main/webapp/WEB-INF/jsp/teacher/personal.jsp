...
<div margin-top="0" align="center">
    ...
    <form method="post" action="/teacherImageUpdate" enctype="multipart/form-data">
...
<div id="nameDiv" style="display: block;">
    <form class="configform" method="post" action="/teacherUpdatePersonal">
        <br>
        <span class="label label-default">${teacher.name}</span>
        <br>
        <br>
        姓名<input id="name" name="name" class="form-control" required="" placeholder=${teacher.name}>
        <br>
        电话<input id="telphone" name="telphone" class="form-control" required="" placeholder=${teacher.telphone}>
        <br>
        邮箱<input id="email" name="email" class="form-control" required="" placeholder=${teacher.email}>
        <br>
